  ...
  return (
    ...
    >
      <div className="relative z-20 w-full flex flex-col justify-center items-center mt-16">
        <div
          className={`px-10 uppercase py-4 flex justify-center items-center text-4xl border-[3px] rounded-xl dark:hover:text-[#111827] dark:hover:bg-red-400 dark:hover:border-[#111827] hover:text-[#f0f0ff] hover:bg-[#6666FF] hover:border-[#f0f0ff] text-[#6666FF] border-[#6666FF] dark:text-red-400 dark:border-red-400 dark:bg-[#111827] bg-[#f0f0ff]  mb-24 ${frukturFont.className}`}
        >
          Skills
        </div>
        <div className="dark:bg-red-400 bg-[#6666FF] w-11/12 md:w-9/12 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2 md:gap-x-4 gap-y-4 mb-40 p-4 md:p-6 rounded-2xl">
