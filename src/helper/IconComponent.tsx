...
function IconComponent({ icon, className = undefined, text }:any) {
  return (
    <div className={`flex items-center justify-evenly gap-2 cursor-default border border-[#6666FF] dark:border-red-400 hover:border-[#cbcbfd] dark:hover:border-red-100 dark:bg-[#111827] bg-[#021709] dark:text-red-400 text-[#6666FF] p-2 lg:w-36 w-32 rounded-md  ${className}`}>
